...
import 'package:netflix_app/infrastructure/downloads/downloads_repository.dart'
    as _i6;
import 'package:netflix_app/infrastructure/hot_and_new/hot_and_new_imp.dart'
    as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i3.HotAndNewServices>(
        () => _i4.HotAndNewImplementation());
    ...
    gh.factory<_i11.HomeBloc>(() => _i11.HomeBloc(gh<_i3.HotAndNewServices>()));
    gh.factory<_i12.HotAndNewBloc>(
        () => _i12.HotAndNewBloc(gh<_i3.HotAndNewServices>()));
